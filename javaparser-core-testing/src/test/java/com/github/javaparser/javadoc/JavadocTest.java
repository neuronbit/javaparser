...
class JavadocTest {
    ...
    void descriptionModificationWorks() {
        ...
        JavadocDescriptionElement inlineTag = new JavadocInlineTag("inheritDoc", INHERIT_DOC, Optional.of(""), Optional.empty());
    ...
    void issue1533() {
        ...
        assertEquals(new JavadocInlineTag("link", LINK, Optional.of(" Foo"), Optional.empty()), elements.get(1));
